import{a as A,r as U,p as _,v as i,N as D,x as u,e as V,k as W,R as $,j as M,M as K,A as L,W as F,f as Q,m as q}from"./index-DIZ15EuH.js";import{r as s,n as w,c as C,U as x}from"./if-defined-x2jrFJEp.js";import"./index-BLZffBNT.js";import{M as R}from"./index-DxKUudk-.js";import"./index-CfFs1i0g.js";import"./index-C2-RVW17.js";import"./index-DSrQL57B.js";import"./index-Bp4Kg_xl.js";import"./index-Dbja6HcD.js";import"./index-DWtBdYXK.js";import"./index-BzsG_V6d.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
