import{a as A,r as U,p as _,v as i,N as D,x as u,e as V,k as W,R as $,j as M,M as K,A as L,W as F,f as Q,m as q}from"./index-2sNBxyT-.js";import{r as s,n as w,c as C,U as x}from"./if-defined-DZyCKWGp.js";import"./index-WvB52iSq.js";import{M as R}from"./index-MVkMQZ38.js";import"./index-5K4hP7Rb.js";import"./index-BdvHAaWC.js";import"./index-aZrz0nYw.js";import"./index-DEBRY_3p.js";import"./index-BkrVhBGZ.js";import"./index-Dxp6vAH1.js";import"./index-ax1JUx1Y.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
